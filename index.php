        ...
        <div class="home-wrapper">
            <div id="home">
                 <span data-picture data-alt="Plane Taking Off from a Dusty Airstrip">
                    <span data-src="../img/takeoff_small.jpg"></span>
                    <span data-src="../img/takeoff_medium.jpg"     data-media="(min-width: 525px)"></span>
                    <span data-src="../img/takeoff_large.jpg"      data-media="(min-width: 769px)"></span>

                    <!-- Fallback content for non-JS browsers. Same img src as the initial, unqualified source element. -->
                    <noscript>
                        <img src="../img/takeoff_small.jpg" alt="Plane Taking Off from a Dusty Airstrip">
                    </noscript>
                 </span>
                ...
                <div class="learn_header">
                    ...
                    <div id="slider_mobile">
                        <span data-picture data-alt="Cessna Over Golden Gate Bridge">
                            <span data-src="../img/plane_over_bridge_small_thin.jpg"></span>
                            <span data-src="../img/space.png" data-media="(min-width: 601px)"></span>

                            <!-- Fallback content for non-JS browsers. Same img src as the initial, unqualified source element. -->
                            <noscript>
                                <img src="../img/space_png" alt="Cessna Over Golden Gate Bridge">
                            </noscript>
                         </span>
                        ...
                        <p class="learn_mobile_answer">You’ll take an introductory flight lesson with <a href="#about">me</a>. The lesson will last about an hour. Bring a friend, too!</p>

                        <span data-picture data-alt="Cessna over a Lake">
                            <span data-src="../img/cessna_lake_small_thin.jpg"></span>
                            <span data-src="../img/space.png" data-media="(min-width: 601px)"></span>

                            <!-- Fallback content for non-JS browsers. Same img src as the initial, unqualified source element. -->
                            <noscript>
                                <img src="../img/space.png" alt="Cessna Over a Lake">
                            </noscript>
                         </span>
                        ...
                        <span data-picture data-alt="Cessna Cockpit">
                            <span data-src="../img/cessna_cockpit_small_thin.jpg"></span>
                            <span data-src="../img/space.png" data-media="(min-width: 601px)"></span>

                            <!-- Fallback content for non-JS browsers. Same img src as the initial, unqualified source element. -->
                            <noscript>
                                <img src="../img/space.png" alt="Cessna Cockpit">
                            </noscript>
                         </span>
                    ...
                    <div class="slider-wrapper theme-default">
                        <div id="slider" class="nivoSlider">
                             ...
                             <span data-picture data-alt="Cessna Over Golden Gate Bridge" data-title="#learn_1">
                                <span data-src="../img/space.png"></span>
                                <span data-src="../img/plane_over_bridge_medium.jpg" data-media="(min-width: 601px)"></span>
                                <span data-src="../img/plane_over_bridge_large.jpg" data-media="(min-width: 769px)"></span>

                                <!-- Fallback content for non-JS browsers. Same img src as the initial, unqualified source element. -->
                                <noscript>
                                    <img src="../img/plane_over_bridge_small.jpg" alt="Cessna Over Golden Gate Bridge" title="#learn_1">
                                </noscript>
                             </span>

                             <span data-picture data-alt="Flying over a Lake" data-title="#learn_2">
                                <span data-src="../img/space.png"></span>
                                <span data-src="../img/cessna_lake_medium.jpg" data-media="(min-width: 601px)"></span>
                                <span data-src="../img/cessna_lake_large.jpg" data-media="(min-width: 769px)"></span>

                                <!-- Fallback content for non-JS browsers. Same img src as the initial, unqualified source element. -->
                                <noscript>
                                    <img src="../img/cesna_lake_small.jpg" alt="Flying over a Lake" title="#learn_2">
                                </noscript>
                             </span>

                            <span data-picture data-alt="Cessna Cockpit" data-title="#learn_3">
                                <span data-src="../img/space.png"></span>
                                <span data-src="../img/cessna_cockpit_medium.jpg" data-media="(min-width: 601px)"></span>
                                <span data-src="../img/cessna_cockpit_large.jpg" data-media="(min-width: 769px)"></span>

                                <!-- Fallback content for non-JS browsers. Same img src as the initial, unqualified source element. -->
                                <noscript>
                                    <img src="../img/cesna_cockpit_small.jpg" alt="Cessna Cockpit" title="#learn_3">
                                </noscript>
                             </span>
                        </div>
                        <div id="learn_1" class="nivo-html-caption">
                            ...
                            <div class="learn_1_textwrap">
                                ...
                                <p class="learn_1_answer">You’ll take an introductory flight lesson with a SF Bay Flyer flight instructor. The lesson will last about an hour. Bring a friend, too!</p>
        ...
        <div class="about-wrapper">
            <div id="about">
                ...
                <div class="about_box_wrap">
                        ...
                        <span data-src="../img/aaron_kahn_small.jpg"></span>
                        <span data-src="../img/aaron_kahn_small_medium.jpg"     data-media="(min-width: 600px)"></span>
                        <span data-src="../img/aaron_kahn_medium.jpg"     data-media="(min-width: 768px)"></span>
                        <span data-src="../img/aaron_kahn_large.jpg"      data-media="(min-width: 1000px)"></span>

                        <!-- Fallback content for non-JS browsers. Same img src as the initial, unqualified source element. -->
                        <noscript>
                            <img src="../img/aaron_kahn_small.jpg" alt="Photo of Aaron Kahn, CFI">
                        </noscript>
                    </span>
                    <div class="about_box">
                        <p class="about_name">Aaron Kahn, <span class="cfi">CFI</span></p>
                        <p class="about_info">Total flight hours: 5,800</p>
                        <p class="about_info">Instructor hours: 2,100</p>
                        ...
                        <p class="about_text">My endorsed students have a pass rate of 82% on their FAA flight tests; my endorsements include Private, Instrument, Multi-Engine, Commercial, Initial CFI (Flight Instructor), CFI-Instrument, and CFI-Multi-Engine ratings. I’ve also trained, endorsed and supervised 11 first-solo flights.</p>
                    </div>
                </div>
            ...
            <div class="contact_training">
                ...
                <div class="contact_container clearfix">
                    <div class="contact_info_form">
                        ...
                        <p class="contact_phone">p. 415.845.8163</p>
                        <p class="contact_email">e. aaron@flyit4u.com</p>


                    </div>    
                    <div class="contact_map">
                        <p class="contact_airport_title">Palo Alto Airport</p>
                        <p class="contact_airport_address">1925 Embarcadero Road</p>
                        ...
                        <a href="http://goo.gl/maps/vsjL2" class="google_map" target="_blank">
